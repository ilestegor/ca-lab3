...
- Выделение переменных и формирование секции данных, которая будет находиться в памяти. Все переменные записываются в
  ...
  происходит синтаксический анализ кода, при возникновении ошибки транслятор будет остановлен и будет выведена ошибка (
  функция [translate_section_data](translator.py))
